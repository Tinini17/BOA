...
function generateMonthlyTransactions(state, year = 2026, startMonth = 0, endMonth = 5, perMonthCounts) {
  ...
  // Stop generation at August 2 for the transaction history (inclusive).
  const today = new Date();
  const cutoffDate = new Date(Date.UTC(2026, 7, 2, 23, 59, 59, 999));
  ...
  for (let m = startMonth; m <= lastAllowedMonth; m++) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const isCurrentMonth = year === cutoffDate.getFullYear() && m === cutoffDate.getMonth();
      if (isCurrentMonth && txDate.getUTCDate() > cutoffDate.getDate()) {
        continue;
      }
  ...
  const recentCutoffDate = new Date(cutoffDate);
  recentCutoffDate.setHours(23, 59, 59, 999);
  ...
  const recentTxs = [
    {
      ...
      category: 'transfer',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(15, 30)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 45).toISOString(),
    ...
    },
    {
      ...
      category: 'card',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(15, 35)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 35).toISOString(),
      amount: -14.75,
      type: 'debit',
      status: 'completed',
      balanceAfter: 0,
    ...
    },
    {
      ...
      title: 'Transfer from Marvins',
      category: 'transfer',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(14, 30)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 90).toISOString(),
    ...
    },
    {
      ...
      category: 'card',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(14, 50)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 80).toISOString(),
      amount: -68.42,
      type: 'debit',
      status: 'completed',
      balanceAfter: 0,
    ...
    },
    {
      ...
      category: 'transfer',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(13, 30)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 120).toISOString(),
    ...
    },
    {
      ...
      category: 'card',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(13, 48)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 110).toISOString(),
      amount: -122.90,
      type: 'debit',
      status: 'completed',
      balanceAfter: 0,
    ...
    },
    {
      ...
      title: 'Transfer from Mark Zuckerberg',
      category: 'transfer',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(12, 30)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 180).toISOString(),
    ...
    },
    {
      ...
      title: `${randomName()} • Café`,
      category: 'card',
      date: `${monthNames[recentCutoffDate.getMonth()]} ${recentCutoffDate.getDate()} • ${fmtTime(11, 55)}`,
      rawDate: new Date(recentCutoffDate.getTime() - 1000 * 60 * 170).toISOString(),
      amount: -9.50,
      type: 'debit',
      status: 'completed',
      balanceAfter: 0,
  ...
  if (Math.abs(diff) > 0.005) {
    const isCurrentMonth = year === cutoffDate.getFullYear() && endMonth === cutoffDate.getMonth();
    const adjDay = isCurrentMonth ? Math.min(cutoffDate.getDate(), 28) : 28;
    const adjDate = new Date(Date.UTC(year, endMonth, adjDay, 23, 59, 59));
    const adjTx = {
